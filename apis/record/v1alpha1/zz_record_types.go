...
type DataParameters struct {
	...
	Algorithm *int64 `json:"algorithm,omitempty" tf:"algorithm,omitempty"`
	...
	// +kubebuilder:validation:Optional
	DigestType *int64 `json:"digestType,omitempty" tf:"digest_type,omitempty"`
	...
	// +kubebuilder:validation:Optional
	LatDegrees *int64 `json:"latDegrees,omitempty" tf:"lat_degrees,omitempty"`

	// +kubebuilder:validation:Optional
	LatDirection *string `json:"latDirection,omitempty" tf:"lat_direction,omitempty"`

	// +kubebuilder:validation:Optional
	LatMinutes *int64 `json:"latMinutes,omitempty" tf:"lat_minutes,omitempty"`

	// +kubebuilder:validation:Optional
	LatSeconds *float64 `json:"latSeconds,omitempty" tf:"lat_seconds,omitempty"`

	// +kubebuilder:validation:Optional
	LongDegrees *int64 `json:"longDegrees,omitempty" tf:"long_degrees,omitempty"`

	// +kubebuilder:validation:Optional
	LongDirection *string `json:"longDirection,omitempty" tf:"long_direction,omitempty"`

	// +kubebuilder:validation:Optional
	LongMinutes *int64 `json:"longMinutes,omitempty" tf:"long_minutes,omitempty"`

	// +kubebuilder:validation:Optional
	LongSeconds *float64 `json:"longSeconds,omitempty" tf:"long_seconds,omitempty"`

	// +kubebuilder:validation:Optional
	MatchingType *int64 `json:"matchingType,omitempty" tf:"matching_type,omitempty"`
	...
	// +kubebuilder:validation:Optional
	Selector *int64 `json:"selector,omitempty" tf:"selector,omitempty"`
